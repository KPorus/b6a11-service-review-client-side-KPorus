  ...
  let check = (e)=>
  {
    ...
    return (
      ...
      <div className='hero-content flex-col lg:flex-row-reverse'>
        ...
        <img className="md:w-2/3 inline md:inline-block " src="https://img.icons8.com/external-smashingstocks-hand-drawn-black-smashing-stocks/99/null/external-digital-camera-graphic-design-and-photography-smashingstocks-hand-drawn-black-smashing-stocks.png" alt="logo"/>
          <h1 className='text-5xl font-bold'>Register Now !</h1>
          <p className='py-6'>
            Welcome to User.
             Please register for using our services.
          </p>
        </div>
